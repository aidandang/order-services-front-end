...
const OrderCost = ({
  ...
  const totalCalc = () => {
    ...
    total += costing.salesTax ? costing.salesTax : 0 + costing.otherCost ? costing.otherCost : 0
  ...
  return <>
    <tr className="table-row-no-link-cs">
      ...
      <td colSpan="1" className="text-right">{acctToStr(costing.subCost)}</td>
    </tr>
    <tr className="table-row-no-link-cs">
      <td colSpan="4" className="text-right">Sales Tax</td>
      <td colSpan="1" className="text-right">{costing.salesTax ? acctToStr(costing.salesTax) : '.00'}</td>
    </tr>
    <tr className="table-row-no-link-cs">
      <td colSpan="4" className="text-right">Other</td>
      <td colSpan="1" className="text-right">{costing.otherCost ? acctToStr(costing.otherCost) : '.00'}</td>
    </tr>
    <tr className="table-row-no-link-cs">
