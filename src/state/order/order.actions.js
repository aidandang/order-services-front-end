...
export const setCustomerTabActive = payload => ({
  type: OrderActionTypes.SET_CUSTOMER_TAB_ACTIVE,
  payload
})
export const setIsSelectedCustomer = payload => ({
  type: OrderActionTypes.SET_IS_SELECTED_CUSTOMER,
  payload
})
