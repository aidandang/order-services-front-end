...
import OrderInfoForm from '../../components/order/order-info-form.component';
...
import OrderStatusForm from '../../components/order/order-status-form.component';
...
const routes = [
  ...
  { path: "/app/order/:orderId/update-order-info", name: "Update Order Information", Component: OrderInfoForm },
  ...
  { path: "/app/order/:orderId/update-order-status", name: "Update Status", Component: OrderStatusForm },
